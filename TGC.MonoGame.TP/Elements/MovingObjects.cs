...
namespace TGC.MonoGame.TP.Elements
{
    public class MovingObject
    {
        ...
        public void InitializeMovingObject(List<Vector3> Points, GraphicsDevice graphicsDevice, ContentManager content, int movementType = 1, float speed = 10f)
        {
            this.Points = Points;
    ...
    public class MovingLogicalObject
    {
        private List<Vector3> Points { get; set; }

        public LogicalObject Body { get; set; }
        private int movementType { get; set; } //1 = Linear, 2 = Circuit, 3 = Random
        private float speed { get; set; }
